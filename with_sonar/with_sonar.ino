...
{
  servo.write(81);                                    //Rotate the servo to face the front                  
  ...
  if(FrontDistance > 35 || FrontDistance == 0)        //If there is nothing infront of the robot within 40cm or the distance value is 0 (which for the newping libary means no ping was returned) then...
  {
...
void navigate()
{
    ...
    servo.write(175);                                 //Move the servo to the left (my little servos didn't like going to 180 so I played around with the value until it worked nicely)
